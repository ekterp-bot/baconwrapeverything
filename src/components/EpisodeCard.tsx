...
export function EpisodeCard({ episode }: EpisodeCardProps) {
  return (
    <article className="overflow-hidden rounded-lg border border-white/10 bg-stone-950 shadow-xl shadow-black/20">
      ...
      <div className="p-4">
        ...
        <p className="mt-4 rounded-md bg-white/5 px-3 py-2 text-sm font-black text-red-100">
          Rating: {episode.rating === null ? 'Pending' : `${episode.rating.toFixed(1)} / 10`}
        </p>
      </div>
    </article>
  )
